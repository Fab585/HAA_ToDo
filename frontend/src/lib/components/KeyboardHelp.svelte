...
{#if $showKeyboardHelp}
  ...
  >
    ...
    >
      ...
      >
        <div>
          <h2 id="keyboard-help-title" class="text-2xl font-bold text-gray-900 dark:text-white">
            Keyboard Shortcuts
          </h2>
          ...
          <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-blue-800 dark:text-blue-200">
              ...
              <ul class="list-disc list-inside space-y-1 text-blue-700 dark:text-blue-300">
                <li>
                  Press <kbd class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-800 rounded">?</kbd> anytime
                  to view this help
                </li>
                <li>
                  Press <kbd class="px-1.5 py-0.5 bg-blue-100 dark:bg-blue-800 rounded">Esc</kbd> to
                  close modals
                </li>
